...
BroadlinkManager is a [FastAPI](https://fastapi.tiangolo.com/) powered, easy to use system that helps you to work with Broadlink Devices.
With Broadlink manager you can:

- Scan your network for devices.
- Learn and send IR or RF codes
- Random generate RF codes
- Change repeats for existing codes (IR/EF)
